...
//       logging: false,
//       width: 800,
//       height: element.scrollHeight + 100, // Add extra padding for notes
//       windowWidth: 800,
...
//               <div className="w-100 d-flex align-items-center invoice-header-content">
//                 {/* Logo Preview - Enhanced with better error handling */}
//                 {this.props.info.logoPreview && (
//                   <div
//                     className="invoice-logo-container me-4"
//                     style={{ flexShrink: 0 }}
//                   >
//                     <img
...
//                   </div>
//                 )}
//                 <div className="invoice-header-text flex-grow-1">
...
//               </div>
//               <div
//                 className="text-end invoice-amount-due"
...
//         {/* CSS for PDF consistency and modal responsiveness */}
//         <style jsx>{`
      ...
      <div>
        ...
        >
          <div id="invoiceCapture" className="invoice-pdf-container">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              {/* Logo and BillFrom Section */}
              <div className="d-flex flex-column align-items-start invoice-header-content">
                {/* Logo Preview - Positioned above company name */}
                {this.props.info.logoPreview && (
                  <div
                    className="invoice-logo-container mb-3"
